...
<head>
	...
	<title>BELAJAR CODEIGNITER 4 BY PETANIKODE</title>
...
<body>
	...
	<header class="jumbotron jumbotron-fluid">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h1 class="h1">BELAJAR CODEIGNITER 4 BY PETANIKODE</h1>
				</div>
			</div>
		</div>
	</header>
	...
	<footer class="jumbotron jumbotron-fluid mt-5 mb-0">
		<div class="container text-center">Copyright &copy <?= Date('Y') ?> CI Nays</div>
	</footer>
